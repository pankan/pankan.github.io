...
---------------------------------------------------*/	
	...
	var $form = $('form#contactform'),
            url = 'https://script.google.com/macros/s/AKfycbyy_XWV5hOc5VLbkd2vu_wgu3uCznibuVTpij5mmiyqQ-CkHaU/exec';
...
//		}
        ...
        $('#submit').on('click', function (e) {
            ...
            $('#message').hide();
             if ($('#name').val() == '' ){
                  $data = $("<fieldset><div class='error_message'>Tell me your name, Stranger</div></fieldset>")
            }
            else if ($('#email').val() == '' ){
                $data = $("<fieldset><div class='error_message'>What's your email address, "+$('#name').val()+"?</div></fieldset>")
            }
            else if ($('#comments').val() == '' ){
                $data = $("<fieldset><div class='error_message'>Don't be shy "+$('#name').val()+", say something.</div></fieldset>")
            }
                ...
                var ajobj = $.ajax({
                    ...
                    $data = $("<fieldset><div id='success_page'><h3>Your message Successfully.</h3><p>Thank you <strong>"+$('#name').val()+"</strong>, will get back to you ASAP.</p></div></fieldset>"),
